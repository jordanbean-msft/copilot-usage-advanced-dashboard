...
$jobName = $($env:AZURE_RESOURCE_CPUAD_UPDATER_ID)
$loginServer = $($env:AZURE_CONTAINER_REGISTRY_LOGIN_SERVER)
$tag = "azd"
$tag += "-$(Get-Date -Format 'yyyyMMddHHmmss')"
$image = "$($env:AZURE_CONTAINER_REGISTRY_LOGIN_SERVER)/cpuad-updater-job:$($tag)"
...
$projectDir = Resolve-Path "$PSScriptRoot/../cpuad-updater"
